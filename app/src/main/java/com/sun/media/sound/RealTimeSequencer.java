...
class RealTimeSequencer extends AbstractMidiDevice implements Sequencer, AutoConnectSequencer {
    ...
    private static SyncMode[] masterSyncModes = { SyncMode.INTERNAL_CLOCK };
    private static SyncMode[] slaveSyncModes  = { SyncMode.NO_SYNC };

    private static SyncMode masterSyncMode    = SyncMode.INTERNAL_CLOCK;
    private static SyncMode slaveSyncMode     = SyncMode.NO_SYNC;
