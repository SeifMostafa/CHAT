...
public class MainActivity extends FragmentActivity {
    ...
    private final String WordsFilePath = "WORDS.txt", PhrasesFilePath = "PHRASES.txt", AppenddedToOutputFVfile = "_fv.txt", AppenddedToOutputTriggerPointsfile = "_trpoints.txt", AppendedToImageFile = ".png", AppendedToSpeechFile = ".wav";
    SharedPreferences sharedPreferences_words_indicator;
    SharedPreferences.Editor sharedPreferences_words_indicator_editor;
  ...
  */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences_words_indicator = this.getSharedPreferences(WORDS_PREFS_NAME, Context.MODE_PRIVATE);
        sharedPreferences_words_indicator_editor = sharedPreferences_words_indicator.edit();

        // read file into words
        words = readFileintoStrack(WordsFilePath);
        phrases = readFileintoStrack(PhrasesFilePath);

        if (sharedPreferences_words_indicator.getAll().isEmpty()) {
            word_loop = 0;
            word_index = 0;
            SaveOnSharedPref(WordLoopKey, String.valueOf(word_loop));
            SaveOnSharedPref(WordIndexKey, String.valueOf(word_index));
        } else {
            word_loop = Integer.parseInt(sharedPreferences_words_indicator.getString(WordLoopKey, "0"));
            word_index = Integer.parseInt(sharedPreferences_words_indicator.getString(WordIndexKey, "0"));
        }
    ...
    public void SaveOnSharedPref(String key, String value) {
        sharedPreferences_words_indicator_editor.putString(key, value).apply();
        sharedPreferences_words_indicator_editor.commit();
    }
