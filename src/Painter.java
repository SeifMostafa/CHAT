...
public class Painter {
			...
			btn_nxt.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					if (words.isEmpty()) {
						...
						frame.dispose();
						JOptionPane.showMessageDialog(new JFrame(),"finished language characters!" , "Thanks!", JOptionPane.INFORMATION_MESSAGE);
	...
	private void CleanSaveDirectionsAndTriggerPoints(ArrayList<Point> triggerpoints, Direction[] dirs, String word) {
		...
		Utils.writePointsStackTofile(triggerpoints, Utils.TriggerPointsOutputPATH + word + Utils.AppenddedToOutputTriggerPointsfile);
	}
